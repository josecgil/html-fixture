...
var HtmlFixture = function () {
    ...
    _createClass(HtmlFixture, [{
        ...
        key: "elementByTag",
        value: function elementByTag(tagName) {
            return this._root.getElementsByTagName(tagName)[0];
        }
    }, {
        key: "elementBySelector",
        value: function elementBySelector(selector) {
            return this._root.querySelector(selector);
        }
    }, {
        key: "elementsByTag",
        value: function elementsByTag(tagName) {
            return this._root.getElementsByTagName(tagName);
        }
    }, {
        key: "elementsBySelector",
        value: function elementsBySelector(selector) {
        ...
        value: function isEqual(param) {
            var myHtml = this._normalizeHtml(this._root.innerHTML);
